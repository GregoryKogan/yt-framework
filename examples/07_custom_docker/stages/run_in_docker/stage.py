...
class RunInDockerStage(BaseStage):
    def run(self, debug: DebugContext) -> DebugContext:
        ...
        self.logger.info(f"Image: {self.config.client.operations.vanilla.resources.docker_image}")
        ...
        self.logger.info("Docker operation completed successfully - check logs for whale ASCII art!")
