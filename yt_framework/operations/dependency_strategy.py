...
class TarArchiveDependencyBuilder:
    ...
    def build_dependencies(
        ...
        log_header(logger, f"{operation_type.title()} Operation", "Preparing (Tar Archive Mode)")
        ...
        if operation_type == "map":
            ...
            if "checkpoint" in operation_config and operation_config.checkpoint.get("checkpoint_base"):
